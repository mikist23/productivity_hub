...
import { ArrowRight, Lock, Mail, User, Chrome, Sparkles, Target, Clock, Zap, CheckCircle2 } from "lucide-react"
          ...
          <Card className="border-border/50 shadow-2xl shadow-black/20 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                >
                  {didSucceed ? "Account created!" : isSubmitting ? "Creating account..." : "Create account"}
